            ...
            <div className="container px-5 py-14 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        <h2 className="text-sm title-font text-gray-500 tracking-widest">goCart</h2>
                        ...
                        <p className="leading-relaxed md:h-40 h-20">{product.attributes.Description}</p>
...
export async function getServerSideProps(context) {
    ...
    let a = await fetch('http://localhost:1337/api/products?populate=*&&filters[Slug]=' + context.query.slug, { headers: header })
